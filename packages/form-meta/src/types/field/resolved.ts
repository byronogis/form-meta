...
> = {
  [K in StringKeys<TRawFieldsMeta> as ArrayIncludes<TResolveFieldsMetaOptions['purge'], NonNullable<TRawFieldsMeta[K]>['nested']> extends true
    ...
    ? ResolvedArrayFieldMeta<NonNullable<TRawFieldsMeta[K]>['subfields'], K, NonNullable<TRawFieldsMeta[K]>['initialValue'], TFieldType, TFieldExtends, TResolveFieldsMetaOptions, JoinPath<TPrefix, K>>
    : NonNullable<TRawFieldsMeta[K]> extends { nested: 'object' }
      ? ResolvedObjectFieldMeta<NonNullable<TRawFieldsMeta[K]>['subfields'], K, NonNullable<TRawFieldsMeta[K]>['initialValue'], TFieldType, TFieldExtends, TResolveFieldsMetaOptions, JoinPath<TPrefix, K>>
      : ResolvedPrimitiveFieldMeta<K, NonNullable<TRawFieldsMeta[K]>['initialValue'], TFieldType, TFieldExtends>
} & FlattenedSubfields<
  TRawFieldsMeta,
  TFieldType,
  TFieldExtends,
